...
function InfoRow({
  ...
  return (
    <div className="flex items-start gap-3 border-b border-stone-300 py-2 last:border-0">
      <Icon className="mt-0.5 h-4 w-4 flex-shrink-0 text-gray-600" aria-hidden="true" />
      <div>
  ...
  return (
    <div className="flex flex-col gap-4">
      <div>
        ...
        {brandNames && <p className="mt-0.5 text-xs text-gray-600">Also known as: {brandNames}</p>}
      </div>
      {molecule && (
      ...
      {description && (
        <div>
          <div className="mb-2 flex items-center gap-2">
            <BookOpen className="h-3.5 w-3.5 text-gray-600" aria-hidden="true" />
