...
const TYPE_CONFIG = {
  outbreak: { Icon: Zap, colour: 'text-red-400', bg: 'bg-red-950/40', label: 'Outbreak' },
  intervention: {
    Icon: Shield,
  ...
  milestone: { Icon: Flag, colour: 'text-green-400', bg: 'bg-green-950/40', label: 'Milestone' },
  warning: {
    Icon: AlertTriangle,
  ...
  return (
    <div className="flex gap-3">
      <div className="flex flex-col items-center">
        ...
        {!isLast && <div className="mt-1 w-px flex-1 bg-slate-800" aria-hidden="true" />}
      </div>
      <div className="pb-5">
        ...
        <p className="mt-0.5 text-xs font-semibold text-slate-200">{event.title}</p>
