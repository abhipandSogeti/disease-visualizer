    ...
    <div className="flex items-center gap-3 px-4 py-2">
      ...
      <div className="relative flex-1">
        <input
          ...
          aria-valuemax={max}
          aria-valuenow={value}
          className="w-full cursor-pointer appearance-none rounded-full bg-stone-300 h-1.5 [&::-webkit-slider-thumb]:h-4 [&::-webkit-slider-thumb]:w-4 [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:bg-blue-500"
        />
        <div
          className={[
